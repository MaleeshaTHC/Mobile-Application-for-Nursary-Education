  ...
  render() {
    return (
      <ImageBackground
        ...
        style={styles.screen}>
        <ScrollView>
          <Text style={styles.main}>Little Kingdom Nursery</Text>
          ...
          <Text style={styles.modal_text}>
            Maleesha T. H.C. built the Little Kingdom Nursery app as a Free app.
            This SERVICE is provided by Maleesha T. H.C. at no cost and is
            ...
            are accessible at Little Kingdom Nursery unless otherwise defined in
            this Privacy Policy.
          </Text>
          <Text style={styles.modal_sub}>Information Collection and Use</Text>
          <Text style={styles.modal_text}>
            OFor a better experience, while using our Service, I may require you
          ...
          <Text style={styles.modal_text}>
            Maleesha T. H.C. is committed to ensuring that the app is as useful
          ...
          <Text style={styles.modal_text}>
            The Little Kingdom Nursery app stores and processes personal data
          ...
          <Text style={styles.points}>Facebook</Text>
          <Text style={styles.modal_text}>
            You should be aware that there are certain things that Maleesha T.
            H.C. will not take responsibility for. Certain functions of the app
            ...
            but Maleesha T. H.C. cannot take responsibility for the app not
          ...
          <Text style={styles.modal_text}>
            ...
            you can’t turn it on to avail the Service, Maleesha T. H.C. cannot
            accept responsibility.
          </Text>
          <Text style={styles.modal_text}>
            With respect to Maleesha T. H.C.’s responsibility for your use of
            ...
            us so that we can make it available to you. Maleesha T. H.C. accepts
          ...
          <Text style={styles.modal_text}>
            ...
            to keep using the app. Maleesha T. H.C. does not promise that it
          ...
          <Text />
          <Text style={styles.contact_text}>littlekingdom@gmail.com.</Text>
          <Text style={styles.contact_text}>www.littlekingdom.com</Text>
